...
exports.send200 = function (res, optionalBody) {
  sendResponse(res, 200, optionalBody);
}

exports.send200WithHeader = function (res, headerKey, headerValue, optionalBody) {
  sendResponse(res, 200, optionalBody, { "key": headerKey, "value": headerValue });
}

exports.send401 = function (res, optionalMessage) {
